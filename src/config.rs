...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "C1sco@123".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["www.2n.pub"];
pub const RS_PUB_KEY: &str = "J+emGbdu9qyCSJ6F61HIwEefX6zOU9UCK+8B6gRtWqs=";
